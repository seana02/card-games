...
export default function C1() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="card" preserveAspectRatio="none" viewBox="-120 -168 240 336">
            ...
            <use href="#SCA" height="70" width="70" x="-35" y="-35"></use>
            <use href="#VCA" height="32" width="32" x="-114.4" y="-156"></use>
            <use href="#SCA" height="26.769" width="26.769" x="-111.784" y="-119"></use>

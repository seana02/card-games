		...
		<svg xmlns="http://www.w3.org/2000/svg" className="card" height="3.5in" preserveAspectRatio="none" viewBox="-120 -168 240 336" width="2.5in">
			<defs>
				...
				<symbol id="VH7" viewBox="-500 -500 1000 1000" preserveAspectRatio="xMinYMid">
					<path className="label-value-red" d="M-265 -320L-265 -460L265 -460C135 -200 -90 100 -90 460" stroke-width="80" stroke-linecap="square" stroke-miterlimit="1.5" fill="none"></path>
				</symbol>
			</defs>
			<rect className="rect" width="239" height="335" x="-119.5" y="-167.5" rx="12" ry="12"></rect>
					<use href="#VH7" height="32" width="32" x="-114.4" y="-156"></use>
					<use href="#SH7" height="26.769" width="26.769" x="-111.784" y="-119"></use>
					<use href="#SH7" height="70" width="70" x="-87.501" y="-135.501"></use>
					<use href="#SH7" height="70" width="70" x="17.501" y="-135.501"></use>
					<use href="#SH7" height="70" width="70" x="-87.501" y="-35"></use>
					<use href="#SH7" height="70" width="70" x="17.501" y="-35"></use>
					<use href="#SH7" height="70" width="70" x="-35" y="-85.25"></use>

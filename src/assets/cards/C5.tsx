...
export default function C5() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="card" height="3.5in" preserveAspectRatio="none" viewBox="-120 -168 240 336" width="2.5in">
            ...
            <use href="#VC5" height="32" width="32" x="-114.4" y="-156"></use>
            <use href="#SC5" height="26.769" width="26.769" x="-111.784" y="-119"></use>
            <use href="#SC5" height="70" width="70" x="-87.501" y="-135.588"></use>
            <use href="#SC5" height="70" width="70" x="17.501" y="-135.588"></use>
            <use href="#SC5" height="70" width="70" x="-35" y="-35"></use>

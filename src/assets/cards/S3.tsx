	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" className="card" height="3.5in" preserveAspectRatio="none" viewBox="-120 -168 240 336" width="2.5in">
			...
			<rect className="rect" width="239" height="335" x="-119.5" y="-167.5" rx="12" ry="12"></rect>
					<use href="#VS3" height="32" width="32" x="-114.4" y="-156"></use>
					<use href="#SS3" height="26.769" width="26.769" x="-111.784" y="-119"></use>
					<use href="#SS3" height="70" width="70" x="-35" y="-135.501"></use>
					<use href="#SS3" height="70" width="70" x="-35" y="-35"></use>

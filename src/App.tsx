...
export default function App() {
    ...
    const [socket, _]: [Socket<socketTypes.ServerToClientEvents, socketTypes.ClientToServerEvents>, any] = useState(io(import.meta.env.VITE_SERVER_URL || 'http://localhost:3000', {
        autoConnect: false
    }));
